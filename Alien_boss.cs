...
public class Alien_boss : pathfinding_agent
{
    ...
    private void Start()
    {
        //frontier.Enqueue(NearestNode(thisTransform));
        //transform.position = frontier.Peek().position;
        //cameFrom.Add(NearestNode(thisTransform), null);
    }
