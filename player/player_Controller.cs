...
public class player_Controller : MonoBehaviour
{
    ...
    [SerializeField] Animator extinguiser;
    ...
    private void AnimatorHandle()
    {
        ...
        //extinguiser.localScale = new Vector3((float)HorMovVal / Mathf.Abs(HorMovVal) ,1,1);
        extinguiser.SetFloat("horizontal", HorMovVal);
    ...
    void attack()
    {
        ...
        if(shootingVec != Vector2.zero)
        {
            Instantiate(projectile, ShotPoint.transform.position, Quaternion.Euler(0,0, getRotation()));
